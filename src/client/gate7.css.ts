...
.sm-native-link { min-height: 34px; padding: 0 10px; border: 0; border-radius: 4px; background: transparent; color: #6e757d; font: 11px/1.2 inherit; text-align: left; cursor: pointer; }
...
.gate-button.sm-button { position: relative; display: inline-flex; min-height: 30px; align-items: center; justify-content: center; padding: 0 12px; border: 1px solid #d7d4cc; border-radius: 5px; background: #fff; color: #30353a; font: 500 12px/1.1 inherit; cursor: pointer; transition: background 120ms ease, border-color 120ms ease; }
...
.row-link { border: 0; background: transparent; color: #2267c7; font: 500 12px/1.2 inherit; white-space: nowrap; cursor: pointer; text-decoration: none; }
...
.rail-button, .file-button { display: grid; width: 100%; min-height: 34px; grid-template-columns: 24px minmax(0,1fr) auto; align-items: center; gap: 6px; padding: 0 8px; border: 0; border-radius: 4px; background: transparent; color: #5e6872; font: 12px/1.2 inherit; text-align: left; cursor: pointer; }
...
.document-editor { width: 100%; min-height: 330px; padding: 16px 0; border: 0; outline: 0; resize: vertical; background: transparent; color: #2f363d; font: 16px/1.7 inherit; tab-size: 2; }
